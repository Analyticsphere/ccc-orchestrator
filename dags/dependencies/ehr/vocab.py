...
def harmonize_source_target(
    file_path: str,
    site: str,
    project_id: str,
    dataset_id: str
) -> None:
    """Execute the source_target harmonization step."""
    harmonize_vocab_step(
        file_path=file_path,
        site=site,
        project_id=project_id,
        dataset_id=dataset_id,
...
def harmonize_target_remap(
    file_path: str,
    site: str,
    project_id: str,
    dataset_id: str
) -> None:
    """Execute the target_remap harmonization step."""
    harmonize_vocab_step(
        file_path=file_path,
        site=site,
        project_id=project_id,
...
def harmonize_target_replacement(
    file_path: str,
    site: str,
    project_id: str,
    dataset_id: str
) -> None:
    """Execute the target_replacement harmonization step."""
    harmonize_vocab_step(
        file_path=file_path,
        site=site,
        project_id=project_id,
...
def harmonize_domain_check(
    file_path: str,
    site: str,
    project_id: str,
    dataset_id: str
) -> None:
    """Execute the domain_check harmonization step."""
    harmonize_vocab_step(
        file_path=file_path,
        site=site,
        project_id=project_id,
...
def harmonize_omop_etl(
    file_path: str,
    site: str,
    project_id: str,
    dataset_id: str
) -> None:
    """Execute the omop_etl harmonization step."""
    harmonize_vocab_step(
        file_path=file_path,
        site=site,
        project_id=project_id,
